...
$$y_1 = \bigg(1+\frac{1}{3}\bigg)^3 y_0 \approx 2.37 y_0,$$

or:

$$y_1 = \bigg(1+\frac{1}{4}\bigg)^4 y_0 \approx 2.44 y_0,$$
...
And maybe you even remember that this limit turns out to be one of the definitions of Euler's number $e$, i.e.:
...
After I learned about limits, the next topic in college was derivatives; if I differentiate the above expression with respect to $x$ I get:
...
as a context-less definition. When I was taking Calculus 1, if someone had been telling a story about how one of the Bernoullis studied a problem from financial mathematics, I would have nodded along, noted the limit from above and, instead of pondering the ancient masters, focused on the X other topics I had to face as a physics freshman. Then, during the exam, if the professor were to ask what is the definition of $e$, I would have been perfectly capable of writing down the limit and likely proving some sort of existence and finiteness. I would have known that limit of $(1+1/n)^n$ as $n\rightarrow\infty$ but I would not have _known_ it. There is a difference between learning and deep, intuitive understanding; the latter being accessible only through careful, active examination and repeated use of knowledge.
